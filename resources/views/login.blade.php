            ...
            <div class="mt-8">
                <form action="/login" method="post">
                    ...
                    @foreach ($errors as $error)
                        <div role="alert" class="mb-2 rounded border-l-4 border-red-500 bg-red-50 p-4">
                    ...
                    <div class="flex flex-col mb-2">
                        <div class="flex relative ">
                            ...
                            <input name="email" type="text"
                                ...
                                placeholder="Your email" autocomplete="off" value=" " />
                        </div>
                    </div>
                    ...
                    <div class="flex
                                w-full">
                        <button type="submit"
                            class="py-2 px-4 block w-full rounded border border-indigo-600 bg-indigo-600  text-white hover:bg-black hover:text-white focus:outline-none focus:ring active:text-white  ">
                            Login
                        </button>
                    </div>
                </form>
